...
from pylinac.common.common_functions import Prof_Penum, point2edge_min, peak_detect
...
class Starshot(AnalysisModule):
    ...
    def analyze(self, allow_inversion=True, radius=50, min_peak_height=30, SID=0):
        ...
        self.circleprofile.get_profile(self.image.pixel_array, radius, self._algo_startpoint)

        # find the radiation lines using the peaks of the profile
        self.lines = self.circleprofile.find_rad_lines(min_peak_height)
    ...
    def plot_analyzed_image(self, plot=None):
        ...
        # plot profile circle
        self.circleprofile.add_to_figure(imgplot)
