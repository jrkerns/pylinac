...
MOCK_MODULES = ['dicom','PySide','PyQt4','numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot',
                'scipy.ndimage', 'scipy.optimize','scipy.misc','matplotlib.patches', 'matplotlib.cm']
...
from pylinac import __version_info__
version = str(__version_info__[:-1])
...
latex_documents = [
  ('index', 'Pylinac.tex', 'Pylinac Documentation',
   'James Kerns', 'manual'),
]
...
man_pages = [
    ('index', 'pylinac', 'Pylinac Documentation',
     ['James Kerns'], 1)
]
...
texinfo_documents = [
  ('index', 'Pylinac', 'Pylinac Documentation',
   'James Kerns', 'Pylinac', 'One line description of project.',
   'Miscellaneous'),
]
