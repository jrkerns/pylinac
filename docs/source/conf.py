...
html_extra_path = ["../../pylinac/phantoms/cp_manuals"]
...
latex_documents = [
    (master_doc, "pylinac.tex", "pylinac Documentation", "James", "manual"),
]
...
man_pages = [(master_doc, "pylinac", "pylinac Documentation", [author], 1)]
