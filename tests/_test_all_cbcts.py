...
class VarianPelvis(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.87, 70: 0.80, 80: 0.69, 90: 0.58, 95: 0.46}
...
class VarianPelvisSpotlight(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.19, 80: 1.15, 90: 0.85, 95: 0.70}
...
class VarianLowDoseThorax(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.73, 70: 0.64, 80: 0.54, 90: 0.44, 95: 0.38}
...
class VarianStandardHead(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.19, 80: 0.97, 90: 0.81, 95: 0.33}
    avg_line_length = 49.94
    lowcon_visible = 1
...
class VarianLowDoseHead(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.02, 80: 0.87, 90: 0.71, 95: 0.40}
    lowcon_visible = 1
...
class GEMonthlyCT(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.64, 70: 0.56, 80: 0.48, 90: 0.41, 95: 0.32}
    lowcon_visible = 4
...
class ToshibaMonthlyCT(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.55, 70: 0.45, 80: 0.36, 90: 0.28, 95: 0.24}
    lowcon_visible = 5
...
class CBCT1(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.19, 80: 1.12, 90: 0.86, 95: 0.53}
...
class CBCT2(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.90, 70: 0.84, 80: 0.75, 90: 0.59, 95: 0.48}
    lowcon_visible = 3
...
class CBCT3(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.87, 70: 0.82, 80: 0.70, 90: 0.55, 95: 0.48}
...
class CBCT5(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.80, 70: 0.71, 80: 0.62, 90: 0.50, 95: 0.45}
...
class CBCT6(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.19, 80: 0.91, 90: 0.68, 95: 0.59}
    avg_line_length = 49.94
    lowcon_visible = 5
...
class CBCT7(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.87, 70: 0.73, 80: 0.61, 90: 0.49, 95: 0.43}
...
class CBCT8(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.19, 80: 0.89, 90: 0.56, 95: 0.27}
...
class CBCT9(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.88, 70: 0.82, 80: 0.70, 90: 0.55, 95: 0.47}
...
class CBCT10(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.19, 70: 1.19, 80: 0.96, 90: 0.83, 95: 0.68}
    lowcon_visible = 4
    thickness_passed = False
...
class CBCT11(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.00, 70: 1.00, 80: 0.93, 90: 0.45, 95: 0.60}
    avg_line_length = 49.94
    lowcon_visible = 4
...
class CBCT12(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.67, 70: 0.59, 80: 0.51, 90: 0.44, 95: 0.40}
...
class CBCT13(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.83, 70: 0.74, 80: 0.62, 90: 0.50, 95: 0.44}
...
class CBCT14(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.70, 70: 0.61, 80: 0.53, 90: 0.45, 95: 0.41}
...
class CBCT15(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.82, 70: 0.72, 80: 0.61, 90: 0.51, 95: 0.45}
    lowcon_visible = 6
...
class CBCT16(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 0.72, 70: 0.59, 80: 0.51, 90: 0.42, 95: 0.34}
...
class CBCT17(CBCTMixin, unittest.TestCase):
    ...
    mtf_values = {60: 1.00, 70: 1.00, 80: 1.00, 90: 0.88, 95: 0.60}
    avg_line_length = 49.94
    lowcon_visible = 1
